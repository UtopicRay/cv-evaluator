      ...
      <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="hidden lg:block">
          <div className="space-y-6">
            ...
            <h1 className="text-4xl font-bold text-balance leading-tight">Bienvenido de vuelta</h1>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Accede a tu cuenta para continuar evaluando y mejorando tus currículums con nuestra tecnología de IA.
            </p>
            <div className="space-y-4 pt-8">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium">Análisis instantáneo</p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium">Seguimiento de progreso</p>
                  <p className="text-sm text-muted-foreground">Visualiza tu evolución</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Mejora continua</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <form className="space-y-4">
              <div className="space-y-2">
                ...
                <Input id="email" type="email" placeholder="tu@email.com" className="bg-background" />
              </div>
