      ...
      <section className="container mx-auto px-4 py-20 md:py-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto text-pretty leading-relaxed">
            Obtén una calificación profesional de tu CV con análisis detallado
            impulsado por IA. Descubre fortalezas y áreas de mejora para
            destacar en tu búsqueda laboral.
          </p>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              Tres simples pasos para mejorar tu CV
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="p-6 bg-card border-border hover:border-primary/50 transition-colors">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Carga tu currículum en formato PDF o DOCX. Nuestro sistema lo
                procesará de forma segura.
              </p>
            </Card>
            <Card className="p-6 bg-card border-border hover:border-primary/50 transition-colors">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Nuestra IA evalúa estructura, contenido, palabras clave y
                formato profesional.
              </p>
            </Card>
            <Card className="p-6 bg-card border-border hover:border-primary/50 transition-colors">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Obtén una calificación detallada con recomendaciones específicas
                para mejorar.
              </p>
            </Card>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Evaluación detallada de estructura, contenido y formato profesional",
              },
              {
                icon: TrendingUp,
                title: "Seguimiento de Progreso",
                description:
                  "Visualiza la evolución de tus CVs y mejoras a lo largo del tiempo",
              },
              {
                icon: Sparkles,
                title: "IA Avanzada",
                description:
                  "Tecnología de última generación para análisis preciso y recomendaciones",
              },
              {
                icon: Award,
                title: "Calificación Visual",
                description:
                  "Sistema de puntuación claro con indicadores de color intuitivos",
              },
            ].map((feature, i) => (
              <Card
                key={i}
        ...
        <Card className="max-w-4xl mx-auto p-8 md:p-12 bg-gradient-to-br from-primary/10 to-accent/10 border-primary/20">
          <div className="text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Únete a miles de profesionales que han mejorado sus currículums
              con CVScore
            </p>
            <Link href="/register">
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-sm text-muted-foreground">
              © 2025 CVScore. Todos los derechos reservados.
            </p>
          </div>
        </div>
      </footer>
