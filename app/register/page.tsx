      ...
      <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="hidden lg:block">
          <div className="space-y-6">
            ...
            <h1 className="text-4xl font-bold text-balance leading-tight">Comienza a mejorar tu CV hoy</h1>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Únete a miles de profesionales que han transformado sus currículums con nuestra plataforma impulsada por
              IA.
            </p>
            <div className="space-y-4 pt-8">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Evalúa todos tus CVs</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Feedback en tiempo real</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <form className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="lastName" placeholder="Pérez" className="bg-background" />
                </div>
              </div>
